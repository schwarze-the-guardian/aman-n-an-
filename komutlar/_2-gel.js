...
return [a.Diğer.Doğru, a.Diğer.Yanlış].includes(reaction.emoji.name) && user.id === kullanıcı.id;
};
...
await mesaj.react(a.Diğer.Doğru)
await mesaj.react(a.Diğer.Yanlış)
...
if (reaction.emoji.name === "basarili") {
